...
class FOML(Reptile):
    ...
    FOML is similar to Reptile_validation_data, except that you use the
    gradient from the last mini-batch as the update
    direction.

    There are two ways to sample batches for FOML.
    By default, FOML samples batches just like Reptile_validation_data,
