...
flags.DEFINE_string('training_data_path', 'input/train_imputed_scaled_validation_marked.csv', 'path to training data')
flags.DEFINE_string('testing_data_path', 'input/test_imputed_scaled_validation_marked.csv', 'path to testing data')
...
flags.DEFINE_float('supp_fp', 0.9, 'support value for fp growth')
