...
\hline
\textbf{model\_name}              & \textbf{f2} & \textbf{gmean} & \textbf{bss}        & \textbf{pr\_auc} & \textbf{sampling\_strategy} & \textbf{cost\_matrix} & \textbf{encoding\_strategy} \\ \hline
Weighted Logistic Regression      & 0.74419     & 0.83033        & 0.30348  & 0.53449          & not minority                & \{0: 1, 1: 10\}       & catboost                    \\ \hline
Balanced Bagging Classifier       & 0.74419     & 0.83033        & 0.30348  & 0.53449          & not minority                & -                     & james                       \\ \hline
Weighted XGBoost                  & 0.74380     & 0.80670        & -0.16915 & 0.43013          & not minority                & 10                    & target                      \\ \hline
Weighted Decision Tree Classifier & 0.74380     & 0.80670        & -0.16915 & 0.43013          & not minority                & \{0: 1, 1: 10\}       & glmm                        \\ \hline
\end{tabular}
}
\end{table}
...
\hline
\textbf{model\_name}              & \textbf{f2} & \textbf{gmean} & \textbf{bss}        & \textbf{pr\_auc} & \textbf{sampling\_strategy} & \textbf{cost\_matrix} & \textbf{encoding\_strategy} \\ \hline
Balanced Bagging Classifier       & 0.83691     & 0.88090        & 0.20398207964656812 & 0.54760          & not minority                & -                     & catboost                    \\ \hline
Weighted Decision Tree Classifier & 0.82969     & 0.87858        & 0.2537331996686576  & 0.55676          & all                         & \{0: 162, 1: 639\}    & james                       \\ \hline
Weighted XGBoost                  & 0.82627     & 0.87124        & 0.12935539961343379 & 0.52519          & minority                    & 1                     & target                      \\ \hline
Weighted Logistic Regression      & 0.77406     & 0.83144        & -0.0447735204638795 & 0.46510          & 0.75                        & \{0: 162, 1: 639\}    & mestimator                  \\ \hline
\end{tabular}
}
\end{table}
...
\hline
\textbf{model\_name}     & \textbf{f2} & \textbf{tn} & \textbf{fp} & \textbf{fn} & \textbf{tp} & \textbf{sampling\_strategy} & \textbf{cost\_matrix} & \textbf{encoding\_strategy} & \textbf{roc\_auc} \\ \hline
Weighted SVM             & 0.73222     & 120         & 40          & 6           & 35          & 0.75                        & \{0: 162, 1: 639\}    & catboost                    & 0.80183           \\ \hline
Easy Ensemble Classifier & 0.72314     & 117         & 43          & 6           & 35          & not minority                & -                     & catboost                    & 0.79245           \\ \hline
KNeighbors               & 0.70000     & 152         & 8           & 13          & 28          & 0.75                        & -                     & woe                         & 0.81646           \\ \hline
\end{tabular}
}
\end{table}
...
\hline
\textbf{model\_name}     & \textbf{f2} & \textbf{tn} & \textbf{fp} & \textbf{fn} & \textbf{tp} & \textbf{sampling\_strategy} & \textbf{cost\_matrix} & \textbf{encoding\_strategy} & \textbf{roc\_auc} \\ \hline
Weighted SVM             & 0.78189     & 119         & 41          & 3           & 38          & 0.5                         & \{0: 1, 1: 10\}       & james                       & 0.83529           \\ \hline
KNeighbors               & 0.77982     & 140         & 20          & 7           & 34          & minority                    & -                     & james                       & 0.85213           \\ \hline
Easy Ensemble Classifier & 0.74419     & 141         & 19          & 9           & 32          & not minority                & -                     & glmm                        & 0.83087           \\ \hline
\end{tabular}
}
\end{table}
...
In the plots above, we realize that, whether with FP or without FP, the models that are trained using top 20 features have better empirical risk curves than those trained using top 10 features. It is also worth noting that although some models are non-monotonic, some are.
...
It is good to note that in all 4 figures above, the precision values do not drop a lot for smaller K values, for some models.
